                    ...
                    <div className="flex flex-1 flex-col overflow-hidden">
                      ...
                      <div className="flex flex-col gap-0.5 rounded bg-bg-secondary px-3 py-2">
                        {generatePreviewLines(item.originalText).map((line, idx) => (
                          <span key={idx} className="truncate font-mono text-xs text-text-secondary">
                            {line}
                          </span>
                        ))}
                      </div>
                    ...
                    <div className="flex flex-1 flex-col overflow-hidden">
                      ...
                      <div className="flex flex-col gap-0.5 rounded bg-bg-secondary px-3 py-2">
                        {generatePreviewLines(item.modifiedText).map((line, idx) => (
                          <span key={idx} className="truncate font-mono text-xs font-semibold text-text-primary">
                            {line}
                          </span>
                        ))}
                      </div>
