...
export function HistoryView() {
  ...
  return (
    <div className="flex h-full w-full flex-col bg-gray-50">
      <div className="flex items-center justify-between border-b border-gray-300 bg-[#F6F8FA] px-6 py-4">
            ...
            {items.map((item) => (
              <div
                ...
                className={clsx(
                  ...
                  item.isBookmarked ? "border-blue-400" : "border-gray-200"
                )}
              >
                {item.isBookmarked && (
                ...
                <div className="relative flex items-center justify-between">
                  ...
                  <div className="mx-4 flex flex-1 items-center gap-4 overflow-hidden">
                    <div className="flex flex-1 flex-col overflow-hidden">
                      ...
                      <div className="flex flex-col gap-0.5 rounded bg-[#F6F8FA] px-3 py-2">
